...
class ModelsDetection:
    def __init__(self):
        self.model_paths = {
            'landslidemodel': r"app\models\landslide.pt",
            'landslidemodel2': r"app\models\building.pt",
            'landslidemodel3': r"app\models\tree.pt",
            'landslidemodel4': r"app\models\landuse2.pt",
        }
        self.models = {}
    ...
    def create_geotiff_with_area(self, polygons, zoom_level, output_file="temp.tiff", area_km2=4):
        ...
        for tile in enumerate(tiles):
            ...
            try:
                ...
                self.create_tiles(out_file_name, tile[0], 2000, 2000)  # Example: tile size 1024x1024 pixels
                # delete file
    ...
    def pixels_to_coordinates(self, tif_file_path, pixel_coords):
        ...
        def transform(x_pixel, y_pixel):
            ...
            return [y, x]  # Swapping the order of coordinates
